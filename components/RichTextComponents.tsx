...
export const RichTextComponents = {
  ...
  block: {
    h1: ({ children }: any) => (
      <h1 className="text-5xl py-10 font-bold text-underline underline-red underline-dashed underline-2">{children}</h1>
    ),
    h2: ({ children }: any) => (
    ...
    blockquote: ({ children }: any) => (
      <blockquote className="border-l-yellow-400 border-l-4 pl-5 py-5 my-5 bg-gray-300">
        {children}
      </blockquote>
    ),
  },
